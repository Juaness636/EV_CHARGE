          ...
          <form onSubmit={doLogin}>
            ...
            <div className="form-group">
              ...
              <div className="password-box">
                ...
                <span className="password-eye" onClick={() => setShowLoginPass((v) => !v)}>
          ...
          <form onSubmit={doRegistro}>
            ...
            <div className="form-group">
              ...
              <div className="password-box">
                ...
                <span className="password-eye" onClick={() => setShowRegPass((v) => !v)}>
            ...
            <div className="form-group">
              ...
              <input type="password" value={regPassConfirm} onChange={(e) => setRegPassConfirm(e.target.value)} placeholder="Repite tu contraseña" onPaste={(e) => e.preventDefault()} onCopy={(e) => e.preventDefault()} onCut={(e) => e.preventDefault()} autoComplete="off" />
            </div>
