...
export function DashboardPage() {
  ...
  const addCalificacion = async (event: FormEvent) => {
    event.preventDefault();
    if (contieneLenguajeOfensivo(calificacionForm.comentario)) { setError(mensajeContenidoOfensivo); return; }
  ...
  const guardarCalificacion = async (event: FormEvent) => {
    event.preventDefault();
    if (contieneLenguajeOfensivo(calificacionForm.comentario)) { setAlertaAccion({ tipo: 'error', texto: mensajeContenidoOfensivo }); return; }
